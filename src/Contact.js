        ...
        <div className="con-page">
            <div className="con-container">
                ...
                <div className="con-HS">
                    ...
                    <span className="con-sub">Hi there, contact me to ask me about anything you have in mind.</span>
                </div>
                <div className="con-form">
                    ...
                    <div className="con-message">
                        ...
                        <textarea id="message" rows="30"  placeholder="Send me a message and I'll reply you as soon as possible..."></textarea>
                    </div>
